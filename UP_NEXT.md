...
- **Formal backup/export/import.** Replace manual SQLite copying and the manual SQL snapshot
  with supported tools.
- **Automatically refreshed corpus snapshot.** Generate and verify the Git snapshot through
